...
function getLangDate(){
    ...
    document.getElementById("nowTime").innerHTML = window.sessionStorage.getItem("userName")+timeValue+"好！ 欢迎使用课堂考勤管理系统   当前时间为： "+newDate+"　"+week;
...
layui.config({
    ...
    //最新数据列表
    // $.get("/ClassAttendance/viewData_selectCount.action",function(data){
    //     //  当前时间
