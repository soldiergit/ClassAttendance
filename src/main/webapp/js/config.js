...
var $config = {
    apiContext: runEnv === 'product' ? 'http://47.106.180.103:8899/ClassAttendance/' : 'http://127.0.0.1:8080/ClassAttendance/', // api请求地址
    resUrl: runEnv === 'product' ? 'http://47.106.180.103:8899/ClassAttendance/' : 'http://127.0.0.1:8080/ClassAttendance/' // 前端资源访问根目录,生产环境请设置为托管前端资源的位置
