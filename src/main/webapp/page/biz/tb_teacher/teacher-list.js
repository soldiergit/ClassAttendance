layui.use(['form', 'layer', 'table', 'laytpl'], function () {
    ...
    var tableIns = table.render({
        ...
        url: '/ClassAttendance/biz/teacher_findByPage.action',//数据接口
        page: true,//开启分页
        ...
        cols: [[//表头
            ...
            {field: 'teacherCode', title: '学号', minWidth: 100, align: 'center'},
            {field: 'teacherName', title: '姓名', minWidth: 100, align: 'center'},
            {field: 'collegeName', title: '所属学院', minWidth: 100, align: 'center', templet:function(d){
    ...
    $(".delBtn").click(function () {
        ...
        if (data.length > 0) {
            ...
            layer.confirm('确定删除选中记录？', {icon: 3, title: '提示信息'}, function (index) {
                $.post("/ClassAttendance/biz/teacher_deleteBatch.action", {
    ...
    table.on('tool(infoList)', function (obj) {
        ...
        if (layEvent === 'edit') { //编辑
            ...
            layer.confirm('确定删除此记录？', {icon: 3, title: '提示信息'}, function (index) {
                $.get("/ClassAttendance/biz/teacher_delete.action", {
        ...
        var index = layui.layer.open({
            ...
            success: function (layero, index) {
                ...
                if (edit) {
                    ...
                    body.find(".updateFlag").val(1);//更新标识标识
                    form.render();
                }
            }
        });
